...
# the real device and asserts the four known-good hashes:
#
...
#   65770cc8ddcbd7c2  golden, async transport / cushion 2 (current)
#   45e240e208179202  groove, arp era (current)
set -e
cd "$(dirname "$0")/.."

GOLDEN_HASH="65770cc8ddcbd7c2"
