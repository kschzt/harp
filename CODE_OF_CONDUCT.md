...
We as members, contributors, and maintainers pledge to make participation in the HARP
...
behavior that they deem inappropriate, threatening, offensive, or harmful. Maintainers
have the right to remove, edit, or reject comments, commits, code, issues, and other
...
the maintainers at **conduct@** *(the project's domain — placeholder; the maintainer
must set the real address)*. All complaints will be reviewed and investigated promptly
