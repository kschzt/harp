 ...
 *
 * The §16 anon_device_section is a THIN WRAPPER over the shared core helper
 * harp_anonymize_device_section (core/src/anonymize.c, deduped in #129) —
 * reachable here via runtime.h's extern "C" { #include "harp/anonymize.h" }.
 */
#include "runtime.h"
