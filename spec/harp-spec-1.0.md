...
Specification, Version 1.1 — 26 June 2026

| | |
|---|---|
| **Status** | **Version 1.1 — stable.** (audio.fx §8.8 added as a backward-compatible capability over the frozen 1.0 wire.) Breaking changes are negotiated at `core.hello` (§5.4) and flow through HARP Enhancement Proposals (§18) |
...
*End of Version 1.1. Earlier drafts of the ideas herein circulated as a product brief titled "Hardware Plugin Runtime"; this document is the open-standard formulation of that work.*
